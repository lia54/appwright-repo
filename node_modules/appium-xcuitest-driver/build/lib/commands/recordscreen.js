...
class ScreenRecorder {
    ...
    async start(timeoutMs) {
        ...
        try {
            await device_connections_factory_1.DEVICE_CONNECTIONS_FACTORY.requestConnection(this.udid, remotePort, {
    ...
    async interrupt(force = false) {
        ...
        device_connections_factory_1.DEVICE_CONNECTIONS_FACTORY.releaseConnection(this.udid, this.opts.remotePort);
        return result;
    }
    async finish() {
